...
namespace Core.Migrations
{
    ...
    [Migration("20221026143443_UpdateTrainingCourses")]
    partial class UpdateTrainingCourses
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.TestQuestions", b =>
                {
                    b.HasOne("Core.Models.TrainingCost", "Course")
                        .WithMany()
                        .HasForeignKey("CourseId");
                });
            ...
            modelBuilder.Entity("Core.Models.TrainingVideos", b =>
                {
                    b.HasOne("Core.Models.TrainingCost", "Name")
                        .WithMany()
                        .HasForeignKey("CourseId");
                });
