...
namespace Academy_App.Controllers
{
    public class AccountsController : Controller
    {
        ...
        public AccountsController(AppDbContext context, UserManager<ApplicationUser> userManger, SignInManager<ApplicationUser> signInManager, 
            IDropdownHelper dropdownHelper, IApplicationHelper applicationHelper, IEmailHelper emailHelper, IUserHelper userHelper)
        {
            _context = context;
