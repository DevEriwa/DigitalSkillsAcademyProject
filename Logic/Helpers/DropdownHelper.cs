...
namespace Logic.Helpers
{
    public class DropdownHelper: IDropdownHelper
    {
        ...
        public List<DropDown> GetApplicationStatusDropDownEnumsList()
        {
            var common = new DropDown()
            {
                Id = 0,
            ...
            var enumList = ((ApplicationStatus[])Enum.GetValues(typeof(ApplicationStatus))).Select(c => new DropDown() { Id = (int)c, Name = c.ToString() }).ToList();
            enumList.Insert(0, common);
            return enumList;
        }
        ...
        public List<DropDown> DropdownOfCoursesWhereIsTested(string userId)
        {
            try
            {
                var common = new DropDown()
        ...
        public List<DropDown> GetExamTypeList()
        {
            var common = new DropDown()
            {
                Id = 0,
            ...
            var enumList = ((ExamType[])Enum.GetValues(typeof(ExamType))).Select(c => new DropDown() { Id = (int)c, Name = c.ToString() }).ToList();
            enumList.Insert(0, common);
            return enumList;
        }
    }
